...
\begin{minipage}{0.92\textwidth}
  ...
  short-horizon state prediction, before committing each decision interval. Under a
  common \emph{realized}-work ceiling, with its own overhead charged in full,
  it \ph{outcome} the constant
...
\input{chapters/04_algorithm}
\input{chapters/05_setup}
\input{chapters/06_benchmark}
\input{chapters/07_controller}
\input{chapters/08_campaign}
\input{chapters/09_ablations}
