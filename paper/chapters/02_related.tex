...
during propagation \citep{atallah2022radial}. What all of these share is that
the selection functional is the local force error, evaluated pointwise.
...
exactly that costate transported to $t_0$. The forward--backward iteration of
