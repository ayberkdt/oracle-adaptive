...
and neither half evaluates the full reference field or the reference truncation
defect along the reference arc. The probe does read the model's coefficients ---
it evaluates the leading omitted bands, which is the point --- and that is the
information boundary of RQ3 as stated, not an exception to it.
