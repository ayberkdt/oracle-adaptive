...
much is it worth, and can any of it be obtained without the information an
oracle has? Three questions organize the paper.
...
Throughout, the budget that is held equal is realized total quadratic work,
including the controller's own overhead, and not a nominal per-call count. The
